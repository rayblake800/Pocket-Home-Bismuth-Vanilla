...
##### Description: ############################################################# 
#
#  A ColourId namespace file generated by ColorID_Namespace_Generator.pl should
# be provided as the input file. This script will read in all color IDs, and 
# prompt the user to sort them into default UI element categories.  
# 
