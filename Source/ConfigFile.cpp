...
//Assign keymaps
const std::map<String, ConfigFile::ComponentType> ConfigFile::componentKeys =
        ConfigFile::setComponentKeys();
const std::map<ConfigFile::ConfigString, String> ConfigFile::stringKeys =
        ConfigFile::setStringKeys();
const std::map<ConfigFile::ConfigBool, String> ConfigFile::boolKeys =
...
String ConfigFile::getConfigString(ConfigFile::ConfigString configString) {
...
void ConfigFile::setConfigString(ConfigFile::ConfigString configString,
        String newValue) {
...
bool ConfigFile::getConfigBool(ConfigFile::ConfigBool configBool) {
    const ScopedLock readLock(lock);
    try {
...
void ConfigFile::setConfigBool(ConfigFile::ConfigBool configBool,
        bool newValue) {
    const ScopedLock writeLock(lock);
    try {
        String key = boolKeys.at(configBool);
...
ConfigFile::ConfigFile() {
    ...
    //load strings
    for (std::map<ConfigFile::ConfigString, String>::const_iterator it =
            stringKeys.begin();
    ...
    //load bools
    for (std::map<ConfigFile::ConfigBool, String>::const_iterator it =
            boolKeys.begin();
            it != boolKeys.end(); it++) {
        String key = it->second;
