 ...
 */
Widgets::Clock::Clock() :
juce::Label("Widgets::Clock", ""),
WindowFocusedTimer("Widgets::Clock")
{
#if JUCE_DEBUG
    setName("ClockLabel");
#endif
 ...
 */
void Widgets::Clock::timerCallback()
{
    updateTime();
 ...
 * visibility is lost.
 */
void Widgets::Clock::visibilityChanged()
{
    if (isVisible())
    {
        if (!showClock)
 ...
 */
void Widgets::Clock::configValueChanged(const juce::Identifier& key)
{
