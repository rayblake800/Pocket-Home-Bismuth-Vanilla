...
/*
 * Animates the transition between on and off states when the switch is clicked,
 * moving the handle left or right as appropriate.
 */
void Widgets::Switch::clicked()
{
    ...
    else
    {
        ...
        {
            juce::Desktop::getInstance().getAnimator().animateComponent(&handle, 
