...
/**
 * @brief  Inheriting this interface ensures that only the
 *         LibNM::Thread::Module may set the DeviceWifi's ObjectLender pointers.
 */
...
public:
     ...
     *
     * @return      The matching access point object, or a null access point if
     *              the access point was not found or this object is null.
     */
