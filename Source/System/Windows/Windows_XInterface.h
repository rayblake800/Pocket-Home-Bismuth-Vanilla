...
public:
    ...
    */
     ...
     *                is invalid or has no class value. 
     */
     ...
     *                window, the last is the window passed in to this function,
     *                and each window in the array is a child of the window 
     *                before it and the parent of the window after it.
     */
     ...
     *                current desktop, has keyboard focus, and is not covered by
     *                other windows.
     */
    ...
    /**
     * @brief  Recursively prints the entire window tree under some root window, 
     *         from front to back.
     * 
...
private:
     ...
     * 
     * @return            The parents array updated to include searchWin and all
     *                    of its parents, or an empty array if searchWin is not 
     *                    a child of the last window in the parents array.
     */
     ...
     *                  pager.
     * 
     * @return          Whether this property is supported by the current window 
     *                  manager or pager.
     */
