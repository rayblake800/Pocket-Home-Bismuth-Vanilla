...
/**
 * @brief  Provides an interface for other objects to request icon Image objects
 *         with a specific name and a preferred size and scale.
 *
 *  The ThreadResource handles these requests asynchronously, searching the
 * user's selected icon theme directories for the closest icon matching the
 * request.
 *
...
public:
    ...
    /**
     * @brief  Holds a pending icon request.
     */
    struct IconRequest
    {
