 ...
 *
 *  Icon themes follow the icon theme specification provided at
...
private:
    ...
    public:
         ...
         *
         * @param scale  The multiplier the icon image will be scaled by when
         *               it is displayed.
         */
         ...
         *
         * @return        A value of < 0 if first is closer than second, a
         *                value of > 0 if second is closer than first, or 0 if
         *                both directories are equally close to the desired
         *                size and scale.
         */
    ...
    private:
         ...
         *
         * @return        Whether this directory is compatible with icons of
         *                the target size and scale.
         */
