...
public:
     ...
     *
     * @throws FormatError   If the name or filename provided do not comply
    ...
    /**
     * @brief  Checks if the EntryFile does not contain all data required by a
     *         valid desktop entry.
     *
     ...
     *
     * @return           True if and only if both entries have identical
     *                   desktop file IDs.
     */
     ...
     * @param toCompare  Another desktop entry to compare with this one.
     *
     * @return           True if this entry's name comes before toCompare's
     *                   name alphabetically, false otherwise.
     */
    bool operator< (const EntryFile& toCompare) const;
     ...
     *
     * @throws FormatError  If the icon value does not comply with desktop
     *                      entry standards.
     */
     ...
     *         terminal window.
     *
     * @param termLaunch  If true, the application will launch in a new
     *                    terminal window. If false, the application will
     *                    launch normally.
     */
...
private:
    /**
     * @brief  Given a standard desktop entry data key, get the value mapped to
     *         that key.
     *
    ...
    /**
     * @brief  Saves data from a desktop entry key/value pair to the
     *         appropriate EntryFile fields.
     *
    ...
    /**
     * @brief  Saves data from a desktop entry line to the most recently
     *         created desktop action.
     *
