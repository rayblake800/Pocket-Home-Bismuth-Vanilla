 ...
 * and remove pages.  It also notifies pages whenever their state on the stack
 * changes, and allows for any page on the stack to remove itself or add a
 * new page to the stack top.
 */
#pragma once
