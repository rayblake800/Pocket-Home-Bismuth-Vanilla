...
class AppMenu::ConfigData : public ItemData, private Localized
{
public:
    ...
    /**
     * @brief  Recursively initializes  menu item data, creating and
     *         initializing all its child folder items.
     *
