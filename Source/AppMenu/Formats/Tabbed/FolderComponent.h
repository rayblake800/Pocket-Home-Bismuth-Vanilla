 ...
 *
 * @brief  Manages the folder buttons in a tabbed AppMenu folder.
 */
class AppMenu::Tabbed::FolderComponent : public AppMenu::FolderComponent
{
public:
    /**
     * @brief  Creates a new tabbed folder component.
     *
