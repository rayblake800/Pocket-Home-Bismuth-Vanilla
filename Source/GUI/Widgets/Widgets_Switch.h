...
private:
     ...
     *                           switch background.
     * 
     * @param isMouseOverButton  Whether the mouse cursor is currently above the
     *                           switch.
     * 
    ...
    /**
     * @brief  Animates the transition between on and off states when the switch
     *         is clicked, moving the handle left or right as appropriate.
     */
