...
#pragma once
/**
 * @file  AppMenu_EntryActions.h
 *
 * @brief  Provides functions for adding and updating desktop entry data in the
 *         AppMenu, shared by AppMenu::EntryLoader and AppMenu::EntryUpdater.
 */
