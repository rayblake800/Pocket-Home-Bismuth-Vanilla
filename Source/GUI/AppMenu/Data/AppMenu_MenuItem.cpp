...
juce::String AppMenu::MenuItem::getTitle() const
{
    if (isNull())
    {
        return juce::String();
...
juce::String AppMenu::MenuItem::getIconName() const
{
    if (isNull())
    {
        return juce::String();
...
juce::String AppMenu::MenuItem::getCommand() const
{
    if (isNull())
    {
        return juce::String();
...
juce::StringArray AppMenu::MenuItem::getCategories() const
{
    if (isNull())
    {
...
AppMenu::MenuItem AppMenu::MenuItem::getParentFolder() const
{
    if (isNull())
    {
        return MenuItem();
...
AppMenu::MenuItem AppMenu::MenuItem::getFolderItem(const int folderIndex) const
{
    if (isNull())
    {
        return MenuItem();
...
juce::Array<AppMenu::MenuItem> AppMenu::MenuItem::getFolderItems() const
{
    if (isNull())
    {
        return {};
...
juce::String AppMenu::MenuItem::getConfirmDeleteTitle() const
{
    if (isNull())
    {
        return juce::String();
...
juce::String AppMenu::MenuItem::getConfirmDeleteMessage() const
{
    if (isNull())
    {
        return juce::String();
...
juce::String AppMenu::MenuItem::getEditorTitle() const
{
    if (isNull())
    {
        return juce::String();
