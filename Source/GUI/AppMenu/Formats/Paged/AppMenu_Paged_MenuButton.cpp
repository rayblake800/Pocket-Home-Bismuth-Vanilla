...
// Finds the area relative to the menu button's bounds where the title should
// be drawn.
...
// Checks if this button will fill in its background with its background colour.
