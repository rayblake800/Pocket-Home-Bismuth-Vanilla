...
private:
     ...
     *                  null, in which case a new WifiList::ListButton should
     *                  be created.
     *
...
private:
    ...
    /**
     * @brief  Adds a newly discovered access point to the list, and schedules
     *         a list update.
     *
    ...
    (const Wifi::AccessPoint removedAP) override;

    /**
     * @brief  Updates access point connection controls when a connection
     *         starts to activate.
     *
