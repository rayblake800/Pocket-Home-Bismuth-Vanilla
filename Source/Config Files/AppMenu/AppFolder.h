...
public:
    /**
     * @brief  Create an empty folder, with no name or icon set.
     */
    AppFolder() { }

    /**
     * @brief  Create an AppFolder, initializing all folder data from 
     *         parameters.
     *
    ...
    /**
     * @brief  Create an AppFolder from a JSON object stored in a juce::var.
     *
    ...
    /**
     * @brief   Package the AppFolder as a juce::DynamicObject.
     *
    ...
    /**
     * @brief   Gets the folder's display name.
     *
    ...
    /**
     * @brief   Gets the folder's DesktopEntry application categories.
     *
    ...
    /**
     * @brief   Gets the folder's displayed icon.
     *
    ...
    /**
     * @brief  Sets the folder's display name.
     *
    ...
    /**
     * @brief  Sets the folder's DesktopEntry application categories.
     *
    ...
    /**
     * @brief  Sets the folder's displayed icon.
     *
    ...
    /**
     * @brief   Compares this folder with another folder.
     *
