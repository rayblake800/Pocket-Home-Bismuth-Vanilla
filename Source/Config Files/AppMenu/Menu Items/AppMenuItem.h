...
class AppMenuItem : public Nullable<MenuItemData::Ptr>
{
public:
    /**
    ...
    public:
        ...
        typedef MenuItemData::DataField DataField; 
         ...
         */
        bool isEditable(AppMenuItem menuItem, const DataField dataField)
            const;
         ...
         */
        void setTitle(AppMenuItem menuItem, const juce::String& title) const;
         ...
         */
        void setLaunchedInTerm(AppMenuItem menuItem, const bool launchInTerm)
            const;
         ...
         *                     menu item.
         */
        void setCategories(AppMenuItem menuItem, 
         ...
         */
        bool remove(AppMenuItem toRemove) const;
         ...
         *                  AppMenuItem::Editor.
         */
        void saveChanges(AppMenuItem menuItem) const;
    };
};
