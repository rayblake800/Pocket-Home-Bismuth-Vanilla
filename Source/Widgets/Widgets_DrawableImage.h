...
public:
    /**
     * @brief  ColourId values corresponding to the colors set in 
     *         loadDefaultColours.
     *
     *  By using setColour(imageColourNId, newColor), any part of the image
     * with the same color as defaultColors[N] will have its color changed to
     * newColor.  
     * 
     ...
     * 
     * @param assetFilename  The filename of an image in the asset folder, or
     *                       a full image path. If invalid, the DrawableImage
     *                       will have no image.
     */
     ...
     * @brief  Changes the image drawn by this component.
     * 
     * @param imageFile  Any image file. If invalid, the DrawableImage will have
     *                   no image.
     */
