 ...
 * components and scrolling page content. NavButton's relative position and size
 * are defined in the Layout::Component configuration file, and its image 
 * resources and colors are defined in the Theme::Image configuration file.
 * 
