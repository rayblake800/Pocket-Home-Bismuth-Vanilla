...
/**
 * @brief  A UI widget that allows the user to enter or adjust an integer 
 *         field. 
 *
 *  The user can directly enter a number into the number field, or 
 * increment/decrement its value by pressing the plus and minus buttons on
 * either side of the number field.
 */
class Widgets::Counter : public juce::Component, private juce::Button::Listener,
...
private:   
    /**
     * @brief  Increments or decrements the counter value when the plus or minus 
     *         buttons are clicked.
     * 
     ...
     * @param editor  The counter's internal text editor.
     */
    virtual void textEditorEscapeKeyPressed(juce::TextEditor& editor) override;
