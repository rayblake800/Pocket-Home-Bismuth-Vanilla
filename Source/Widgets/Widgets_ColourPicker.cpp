...
/* Stores previous colour choices to share between all ColourPickers */
 ...
 * Updates the sliders and colour preview after the text box value changes.
 */
void Widgets::ColourPicker::textEditorReturnKeyPressed(juce::TextEditor& editor) 
{
    selectedColour = juce::Colour(editor.getText().getHexValue32());
    setEditorText();
    setSlidersToColour();
...
/*
 * Optionally sets the component's color and border on construction.
 */
