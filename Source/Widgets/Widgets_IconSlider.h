...
public:
     ...
     * 
     * @param newInterval  Controls which values between the minimum and maximum
     *                     are considered valid. If set to a nonzero value, the
     *                     slider value will only change in discrete steps equal
     *                     to the interval size. Otherwise, the slider will be
     *                     able to select any value in the continuous range 
