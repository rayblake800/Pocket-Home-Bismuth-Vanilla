...
void SettingsPageComponent::buttonClicked(Button *button)
{
    ...
    {
        PocketHomeApplication::getInstance()->getMainStack().popPage(PageStackComponent::kTransitionTranslateHorizontal);
    ...
    {
        PocketHomeApplication::getInstance()->getMainStack()
        .pushPage(advancedPage, PageStackComponent::kTransitionTranslateHorizontal);
    }
}
