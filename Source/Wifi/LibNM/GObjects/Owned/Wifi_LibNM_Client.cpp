...
Wifi::LibNM::Client::getWifiDeviceByIface(const char* interface) const
{ 
    ASSERT_NM_CONTEXT;
    GLib::ObjectPtr dataPtr(*this);
    if(dataPtr != nullptr)
 ...
 */
Wifi::LibNM::DeviceWifi 
Wifi::LibNM::Client::getWifiDeviceByPath(const char* path) const
{ 
    ASSERT_NM_CONTEXT;
    GLib::ObjectPtr dataPtr(*this);
    if(dataPtr != nullptr)
...
Wifi::LibNM::Client::getPrimaryConnection() const
{ 
    ASSERT_NM_CONTEXT;
    GLib::ObjectPtr dataPtr(*this);
    if(dataPtr != nullptr)
