...
/**
 * @brief  Defines one component's space within its row of Components.
 */
...
/**
 * @brief  Defines the list of Component rows arranged by the layout.
 *
...
public:
    /**
     * @brief  Creates the layout from an initial set of row layouts.
     *
