 ...
 * objects. Only the GVariant types needed for this project will be supported.
 */
namespace GLib { namespace VariantConverter
{
     ...
     *                   item. Any non-null value returned by this function
     *                   will need to be freed with g_variant_unref();
     */
     ...
     *
     * @tparam T       The value type to extract from the variant. If this does
     *                 not match the variant type, a default value will be
     *                 returned.
     *
     ...
     *
     * @return         The GValue containing the stored data, or G_VALUE_INIT
     *                 if the value could not be transferred.
     */
     ...
     *                  the dictionary. Each call passes in a single key and
     *                  its value as GVariant* objects. These objects will be
     ...
     * @param dict  A GVariant dictionary object.
     *
     * @return      The extracted key strings, or an empty array if dict was
