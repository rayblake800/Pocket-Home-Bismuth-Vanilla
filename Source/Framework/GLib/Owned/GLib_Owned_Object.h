...
protected:
     ...
     *                    its GObject* will be shared, and the GObject's
     *                    reference count will be increased.
     *
     ...
     *                     GObject* has a floating reference, Object will sink
...
public:
     ...
     *
     * @param rhs  A valid GObject to store, or nullptr to convert this Object
     *             into a null object. If this value is floating, the floating
     *             reference will be claimed by the Object. Otherwise, the
     *             reference count will be increased.
     *
     * @return     This Object instance.
     */
