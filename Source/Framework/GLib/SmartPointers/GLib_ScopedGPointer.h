 ...
 *
 * @brief  A template class for holding temporary GLib values that
 *         automatically unreferences or frees its held value on destruction if
 *         necessary.
 */
...
public:
    /**
     * @brief  Create the ScopedGPointer, permanently setting its internal data
     *         pointer.
     *
