...
public:
     ...
     *             that will be assigned to this context pointer. If non-null, a
     *             new reference will be added to the copied GMainContext* that
     *             the SharedContextPtr will later unreference.
     *
     * @return     A reference to this SharedContextPtr. 
     */
