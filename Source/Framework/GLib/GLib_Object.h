...
protected:
     ...
     *
     * @return          A pointer to a copy of the parameter data, or nullptr
     *                  if the parameter wasn't found. If this value is a
     *                  pointer type it must be freed with g_free() or
     *                  g_object_unref(), depending on its type.
     */
