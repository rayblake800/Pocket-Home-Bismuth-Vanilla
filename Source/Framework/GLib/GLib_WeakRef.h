...
public:
     ...
     *
     *  If a non-null value is returned, an additional strong reference will
     * have been added to the returned GObject.
     *
     * @return  The GObject held by this weak reference, or nullptr if this
