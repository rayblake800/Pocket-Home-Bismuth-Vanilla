 ...
 * a bounding box. Vertical margins may be defined using a weight value, or as
 * a fraction of the total bounding box height. Horizontal margins may only be
...
public:
    ...
    /**
     * @brief  Sets the size of the top and bottom margins of the layout using 
     *         a weight value.  
     *
...
public:
     ...
     * 
     * @return  The Component pointer assigned to this RowItem on creation. This
     *          value may be null.
     */
