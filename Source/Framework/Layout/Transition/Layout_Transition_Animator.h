...
/**
 *  Transition::Animator provides methods for animating the transition when 
 * replacing visible Components in the window. It is primarily used to make 
 * removed components slide offscreen while added components slide in from the 
 * opposite direction.  
 */
 ...
 *                               does not intersect with the window bounds,
