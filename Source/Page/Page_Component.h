 ...
 * Page::Type enum class. To be able to create pages, a page must have a pointer
 * to a Page::FactoryInterface object assigned to it on construction.  
 * If it has a Page::FactoryInterface, the page on the top of the page stack can
...
public:
     ...
     *                page, not including the back button. These components will
     *                be added to the page as child components and made visible.
     *                If necessary, the layout margins will be resized to make 
...
private:
     ...
     * destroys it. If this method returns true, that default action will be
     * skipped.
     * 
    ...
    /**
     * @brief  Fills the page background with an image or color.
     *
