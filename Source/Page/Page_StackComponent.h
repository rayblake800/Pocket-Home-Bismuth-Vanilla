 ...
 * 
 *  StackComponent implements Page::Interface::Stack to manage the stack of open
 * page components. It takes ownership of new pages, and allows them to add new
 * pages above themselves or remove and delete themselves from the top of the 
 * stack.
 */
...
private:
     ...
     *
     *  If the page is being added, this will add it to the StackComponent, make
     * it visible, and set its initial bounds. The page will be disabled while
