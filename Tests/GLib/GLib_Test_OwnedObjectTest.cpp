...
class GLib::Test::OwnedObjectTest : public StressTest
{
private:
...
public:
            ...
            minThreadCount, maxThreadCount, threadSleepMS, testSeconds) 
    {
        ...
        addAction(TestAction("Creating a new test Object",
        [this]()
        {
        ...
        addAction(TestAction("Removing a random test object",
        [this]()
        {
            const ScopedLock objectLock(dataLock);
        ...
        addAction(TestAction("Adding a new signal handler to a random Object",
        [this]()
        {
            const ScopedLock objectLock(dataLock);
        ...
        addAction(TestAction("Adding a random signal handler to a random Object",
        [this]()
        {
            const ScopedLock objectLock(dataLock);
            OwnedObject tempObject = randomObject();
        ...
        addAction(TestAction("Destroying a random signal handler",
        [this]()
        {
            const ScopedLock objectLock(dataLock);
            OwnedObject::Listener* listener = randomListener();
        ...
        addAction(TestAction("Setting one random test Object equal to another",
        [this]()
        {
            const ScopedLock objectLock(dataLock);
        ...
        addAction(TestAction("Setting a random test Object to null",
        [this]()
        {
            const ScopedLock objectLock(dataLock);
        ...
        addAction(TestAction("Updating a random test Object's string property",
        [this]()
        {
            const ScopedLock objectLock(dataLock);
            OwnedObject tempObject = randomObject();
        ...
        addAction(TestAction("Updating a random test Object's int property",
        [this]()
        {
            const ScopedLock objectLock(dataLock);
            OwnedObject tempObject = randomObject();
